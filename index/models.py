...
class comments(models.Model):
    aid = models.ForeignKey('article',on_delete=models.CASCADE,related_name='article')
    comm_uid = models.ForeignKey(settings.AUTH_USER_MODEL,verbose_name='评论者',on_delete=models.CASCADE,related_name='comment_user_id')
...
class notify(models.Model):
    is_read = models.IntegerField('是否已读',choices=((1,'已读'),(0,'未读')),default=0)
